...
// console.log(fenomenler[0].followers);
...
function indekseGoreFenomen(array,index) {
 ...
 // return `${index}. indekste bulunan fenomen : ${array[index].profile}`
...
if(dizi[i].platform == platform && dizi[i].posts > maxGonderi){

maxGonderi = dizi[i].posts
maxGonderen = dizi[i].profile;
